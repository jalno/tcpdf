...
class Example_051_MYPDF extends TCPDF {
	//Page header
...
class Example_051 extends Process {

	public function run() {

		// create new PDF document
		$pdf = new Example_051_MYPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
