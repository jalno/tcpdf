...
class Example_062 extends Process {
	...
	public function run() {
		...
		*/
		...
		$pdf->Image(__DIR__ . '/images/image_demo.jpg', 0, 0, 60, 60, '', '', '', true, 72, '', false, false, 0, false, false, false);
