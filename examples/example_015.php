...
class Example_015 extends Process {
	...
	public function run() {
		...
		$pdf->Annotation(20, 50, 5, 5, 'TXT file', array('Subtype'=>'FileAttachment', 'Name' => 'PushPin', 'FS' => __DIR__ . '/data/utf8test.txt'));

		// attach an external file
		$pdf->Annotation(50, 50, 5, 5, 'PDF file', array('Subtype'=>'FileAttachment', 'Name' => 'PushPin', 'FS' =>  __DIR__ . '/example_012.pdf'));
