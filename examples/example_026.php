...
class Example_026 extends Process {
	...
	public function run() {
		...
		$pdf->Image(__DIR__ . '/images/image_demo.jpg', 15, 65, 170, 10, '', '', '', true, 72);
		$pdf->StopTransform();
		...
		$pdf->Image(__DIR__ . '/images/image_demo.jpg', 15, 75, 170, 10, '', '', '', true, 72);
		$pdf->StopTransform();
		...
		$pdf->Image(__DIR__ . '/images/image_demo.jpg', 15, 85, 170, 10, '', '', '', true, 72);
		$pdf->StopTransform();

		$pdf->StartTransform();
		$pdf->setTextRenderingMode($stroke=0, $fill=false, $clip=true);
		$pdf->Write(0, 'Add text to path for clipping', '', 0, '', true, 0, false, false, 0);
		$pdf->Image(__DIR__ . '/images/image_demo.jpg', 15, 95, 170, 10, '', '', '', true, 72);
		$pdf->StopTransform();
