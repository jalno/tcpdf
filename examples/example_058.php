...
class Example_058 extends Process {
	...
	public function run() {
		...
		$pdf->ImageSVG($file= __DIR__ . '/images/testsvg.svg', $x=15, $y=30, $w='', $h='', $link='http://www.tcpdf.org', $align='', $palign='', $border=1, $fitonpage=false);

		$pdf->ImageSVG($file=  __DIR__ . '/images/tux.svg', $x=30, $y=100, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
