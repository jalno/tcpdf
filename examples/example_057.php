...
class Example_057 extends Process {
	...
	public function run() {
		...
		$pdf->Image(__DIR__ . '/images/tcpdf_cell.png', 15, 160, 100, 100, 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);
		$legend = 'LEGEND:
