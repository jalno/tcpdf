...
class TCPDF_STATIC {
	...
	* @since 5.9.121 (2011-09-28)
	 ...
	 * @public static
	 */
	public static function pregSplit($pattern, $modifiers, $subject, $limit=NULL, $flags=0) {
	...
	public static function fopenLocal($filename, $mode) {
		if (strpos($filename, '://') !== false and stream_is_local($filename) !== true) {
			return false;
		}
